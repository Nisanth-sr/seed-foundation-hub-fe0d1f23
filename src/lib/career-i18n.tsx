...
const en: Dict = {
  ...
  "dash.seedReport": "Seed Report",
  "dash.seedReport.locked": "Your counselor will release your Seed Report soon",
  "dash.seedReport.open": "View Seed Report",
  "dash.seedReport.hide": "Hide report",
  "dash.seedReport.summary": "Summary",
  "dash.seedReport.personality": "Personality profile",
  "dash.seedReport.behavioral": "Behavioral patterns",
  "dash.seedReport.strengths": "Strengths",
  "dash.seedReport.growth": "Growth areas",
  "dash.seedReport.workStyle": "Work style",
  "dash.seedReport.team": "Team & social",
  "dash.seedReport.stress": "Stress & resilience",
  "dash.seedReport.guidance": "Career guidance",
  "dash.seedReport.paths": "Recommended paths",
  ...
  "profile.subtitle": "Help your counselor understand your background. You can update this anytime.",
  ...
  "profile.school": "School or college",
  "profile.languages": "Languages spoken",
  "profile.languages.hint": "Comma-separated, e.g. Tamil, English, Hindi",
  "profile.select": "Select…",
  "profile.save": "Save profile",
  "profile.saving": "Saving…",
  "profile.saved": "Profile saved",
  "profile.age.under_15": "Under 15",
  "profile.age.15_17": "15–17",
  "profile.age.18_21": "18–21",
  "profile.age.22_25": "22–25",
  "profile.age.26_30": "26–30",
  "profile.age.31_40": "31–40",
  "profile.age.41_plus": "41+",
  "profile.edu.below_10": "Below 10th",
  "profile.edu.10th": "10th",
  "profile.edu.12th": "12th",
  "profile.edu.diploma": "Diploma",
  "profile.edu.undergraduate": "Undergraduate",
  "profile.edu.postgraduate": "Postgraduate",
  "profile.edu.other": "Other",
  "profile.status.student": "Student",
  "profile.status.working": "Working",
  "profile.status.seeking": "Looking for a job",
...
const ta: Dict = {
  ...
  "dash.seedReport": "Seed அறிக்கை",
  "dash.seedReport.locked": "உங்கள் ஆலோசகர் விரைவில் Seed அறிக்கையை வெளியிடுவார்",
  "dash.seedReport.open": "Seed அறிக்கையைக் காண்",
  "dash.seedReport.hide": "அறிக்கையை மறை",
  "dash.seedReport.summary": "சுருக்கம்",
  "dash.seedReport.personality": "ஆளுமை சுயவிவரம்",
  "dash.seedReport.behavioral": "நடத்தை முறைகள்",
  "dash.seedReport.strengths": "பலங்கள்",
  "dash.seedReport.growth": "வளர்ச்சிப் பகுதிகள்",
  "dash.seedReport.workStyle": "பணி பாணி",
  "dash.seedReport.team": "குழு & சமூகம்",
  "dash.seedReport.stress": "மன அழுத்தம் & மீள்திறன்",
  "dash.seedReport.guidance": "தொழில் வழிகாட்டல்",
  "dash.seedReport.paths": "பரிந்துரைக்கப்பட்ட பாதைகள்",
  ...
  "profile.subtitle": "உங்கள் பின்னணியை ஆலோசகர் புரிந்துகொள்ள உதவுங்கள். எப்போது வேண்டுமானாலும் புதுப்பிக்கலாம்.",
  "profile.displayName": "முழு பெயர்",
  "profile.phone": "தொலைபேசி",
  "profile.ageRange": "வயது வரம்பு",
  "profile.city": "நகரம்",
  "profile.state": "மாநிலம்",
  "profile.education": "கல்வி நிலை",
  "profile.status": "தற்போதைய நிலை",
  "profile.school": "பள்ளி அல்லது கல்லூரி",
  "profile.languages": "பேசும் மொழிகள்",
  "profile.languages.hint": "கமாவால் பிரிக்கவும், எ.கா. தமிழ், ஆங்கிலம், இந்தி",
  "profile.select": "தேர்ந்தெடு…",
  "profile.save": "சுயவிவரம் சேமி",
  "profile.saving": "சேமிக்கிறது…",
  "profile.saved": "சுயவிவரம் சேமிக்கப்பட்டது",
  "profile.age.under_15": "15க்கு கீழ்",
  "profile.age.15_17": "15–17",
  "profile.age.18_21": "18–21",
  "profile.age.22_25": "22–25",
  "profile.age.26_30": "26–30",
  "profile.age.31_40": "31–40",
  "profile.age.41_plus": "41+",
  "profile.edu.below_10": "10க்கு கீழ்",
  "profile.edu.10th": "10ம் வகுப்பு",
  "profile.edu.12th": "12ம் வகுப்பு",
  "profile.edu.diploma": "டிப்ளமோ",
  "profile.edu.undergraduate": "இளங்கலை",
  "profile.edu.postgraduate": "முதுகலை",
  "profile.edu.other": "மற்றவை",
  "profile.status.student": "மாணவர்",
  "profile.status.working": "வேலை செய்பவர்",
  "profile.status.seeking": "வேலை தேடுபவர்",
  "profile.status.other": "மற்றவை",
};
